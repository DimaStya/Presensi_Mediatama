    ...
    <section class="content">
      <div class="box box-success">
        <div class="box-header with-border">
          ...
          ?>
          <form method="POST" action="tanpa_kehadiran.php">
          ...
          <h3 class="box-title">Download Tanpa Presensi </h3>
        ...
        <div class="box-body">
          <div class="box-body no-padding">
              ...
              <tbody>
                <?php
                $no =1;
                $nasional = mysqli_query($con, "SELECT status, kode_nas, nama_nasional FROM tbl_mnasional");
