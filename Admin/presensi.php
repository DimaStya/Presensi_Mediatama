      ...
      <div class="box box-success">
        <div class="box-header with-border">
          ...
          <select id="tanggal_download" name="tanggal_download">
            <!-- <option value="<?php echo date('d-m-Y'); ?>">Hari Ini</option> -->
          ...
          <h3 class="box-title">Download Data Presensi </h3>
                <button type="submit" name="tombol" id="tombol" value="Management" class="btn btn-primary">Management</button>
                <button type="submit" name="tombol" id="tombol" value="Proyek" class="btn btn-primary">Proyek</button>
              </form>
          <?php
            ...
            <div class="scrol">
              ...
              <tbody>
                ...
                while($data_nasional=mysqli_fetch_array($nasional)){
                  $pre_nasional= mysqli_query($con, "SELECT keterangan_1, keterangan_2, keterangan_3, keterangan_4, keterangan_5, tanggal FROM tbl_presensimnasional WHERE kode_nas='".$data_nasional['kode_nas']."' AND tanggal='".$tanggal."'");
                  ...
                  if($num_nasional==1){
                    ...
                    <tr>
                      ...
                      <td>------</td>
                      <td>-----</td>
                      <td>".$data_pre_nasional['keterangan_1']."</td>
                      <td>".$data_pre_nasional['keterangan_2']."</td>
                      <td>".$data_pre_nasional['keterangan_3']."</td>
                      <td>".$data_pre_nasional['keterangan_4']."</td>
                      <td>".$data_pre_nasional['keterangan_5']."</td>
                  ...
                  while($data_area=mysqli_fetch_array($area)){
                    $pre_area = mysqli_query($con, "SELECT keterangan_1, keterangan_2, keterangan_3, keterangan_4, keterangan_5, tanggal FROM tbl_presensimarea WHERE kode_area='".$data_area['kode_area']."' AND tanggal='".$tanggal."'");
                    ...
                    if($num_area==1){
                      ...
                      <tr>
                        ...
                        <td>".$data_area['nama_area']."</td>
                        <td>-----</td>
                        <td>".$data_pre_area['keterangan_1']."</td>
                        <td>".$data_pre_area['keterangan_2']."</td>
                        <td>".$data_pre_area['keterangan_3']."</td>
                        <td>".$data_pre_area['keterangan_4']."</td>
                        <td>".$data_pre_area['keterangan_5']."</td>
                    ...
                    while($data_kaper=mysqli_fetch_array($kaper)){
                      $pre_kaper = mysqli_query($con, "SELECT keterangan_1, keterangan_2, keterangan_3, keterangan_4, keterangan_5, tanggal FROM tbl_presensiperwakilan WHERE kode_perwakilan='".$data_kaper['kode_perwakilan']."' AND tanggal='".$tanggal."'");
                      ...
                      if($num_kaper==1){
                        ...
                        <tr>
                          ...
                          <td>".$data_pre_kaper['keterangan_1']."</td>
                          <td>".$data_pre_kaper['keterangan_2']."</td>
                          <td>".$data_pre_kaper['keterangan_3']."</td>
                          <td>".$data_pre_kaper['keterangan_4']."</td>
                          <td>".$data_pre_kaper['keterangan_5']."</td>
                      ...
                      while($data_sales=mysqli_fetch_array($sales)){
                        $pre_sales = mysqli_query($con, "SELECT keterangan_1, keterangan_2, keterangan_3, keterangan_4, keterangan_5, tanggal FROM tbl_presensisales WHERE kode_sales='".$data_sales['kode_sales']."' AND tanggal='".$tanggal."'");
                        ...
                        if($num_sales==1){
                          ...
                          <tr>
                            ...
                            <td>".$data_area['nama_area']."</td>
                            <td>".$data_kaper['alamat_perwakilan']."</td>
                            <td>".$data_pre_sales['keterangan_1']."</td>
                            <td>".$data_pre_sales['keterangan_2']."</td>
                            <td>".$data_pre_sales['keterangan_3']."</td>
                            <td>".$data_pre_sales['keterangan_4']."</td>
                            <td>".$data_pre_sales['keterangan_5']."</td>
