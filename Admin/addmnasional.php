...
<head>
  ...
  <script src = "js/nasional.js"></script>
  <style type="text/css">
      .pesan_berhasil{
          display: none;
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="addmnasional.php"><i class="fa fa-circle-o"></i> Manager Nasional</a></li>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="box box-primary">
              ...
              <form role="form" action="Proses/proses_nasional.php?aksi=simpan" method="POST">
                <div class="box-body">
      ...
      <div class="box box-success">
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php
                  $no = 1;
                  $query = mysqli_query($con, "SELECT * FROM tbl_mnasional");
                  while($data=mysqli_fetch_array($query)){
                    ...
                    <tr>
                      ...
                      <td>".$data['email']."</td>
                      <td>".$data['status']."</td>
                      <td><button type='button' class='btn-info' data-toggle='modal' data-target='#myModal' onclick=\"SetInput('".$data['kode_nas']."','".$data['nama_nasional']."','".$data['email']."','".$data['status']."')\"><i class='fa fa-fw fa-pencil-square-o'></i></button>|<button onclick='Klik".$no."()' type='button' class='btn-danger'><i class='fa fa-fw fa-sign-out'></i></button></td>
                  </tr>";
                  $no++;
                  }
  ...
  while($data=mysqli_fetch_array($query)){
    echo "
      function Klik".$no."(){
        ...
        if(r == true){
          window.location = 'Proses/proses_nasional.php?aksi=resign&&kode_nas=".$data['kode_nas']."';
        }
