                ...
                <form role="form" action="Proses/proses_sales.php?aksi=simpan" method="POST">
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      <div class="col-xs-6">
                        <label>Jabatan</label>
                        <select id="jabatan" name="jabatan" class="form-control col-xs-6">
         ...
         <table id="example1" class="table table-bordered table-striped">
          ...
          <tbody>
            ...
            while($data=mysqli_fetch_array($query)){
              ...
              <td><button type='button' class='btn-info' data-toggle='modal' data-target='#myModal' onclick=\"SetInput('".$data['kode_sales']."','".$data['nama_sales']."','".$data['email']."','".$data['kode_nas']."')\"><i class='fa fa-fw fa-pencil-square-o'></i></button>|<button onclick='Klik".$no."()'  type='button' class='btn-danger'><i class='fa fa-fw fa-sign-out'></i></button></td>
              </tr>";
              $no++;
            }
