      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="addmarea.php"><i class="fa fa-circle-o"></i> Manager Area</a></li>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title">Kelola Data Manager Area</h4>
        </div>
        <!-- body modal -->
        <div class="modal-body">
          <div class="box box-primary">
            
              <form role="form" action="Proses/proses_area.php?aksi=simpan" method="POST">
                <div class="box-body">
      ...
      <div class="box box-success">
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php
                  $no = 1;
                  $query = mysqli_query($con, "SELECT tbl_marea.kode_nas, tbl_marea.kode_area, tbl_marea.nama_area, tbl_mnasional.nama_nasional, tbl_marea.email, tbl_marea.status FROM tbl_marea,tbl_mnasional WHERE tbl_marea.kode_nas=tbl_mnasional.kode_nas");
                  while($data=mysqli_fetch_array($query)){
                    ...
                    <tr>
                      ...
                      <td>".$data['email']."</td>
                      <td>".$data['status']."</td>
                      <td><button type='button' class='btn-info' data-toggle='modal' data-target='#myModal' onclick=\"SetInput('".$data['kode_area']."','".$data['nama_area']."','".$data['email']."','".$data['status']."','".$data['kode_nas']."')\"><i class='fa fa-fw fa-pencil-square-o'></i></button>|<button onclick='Klik".$no."()' type='button' class='btn-danger'><i class='fa fa-fw fa-sign-out'></i></button></td>
                  </tr>";
                  $no++;
                  }
...
<script type="text/javascript">
  <?php
  $no =1;
  $query = mysqli_query($con, "SELECT * FROM tbl_marea");
  while($data=mysqli_fetch_array($query)){
    echo "
      function Klik".$no."(){
        var r = confirm('Yakin Mau Hapus?');
        if(r == true){
          window.location = 'Proses/proses_area.php?aksi=resign&&kode_area=".$data['kode_area']."';
        }
