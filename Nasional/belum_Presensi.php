            ...
            <div class="scrol">
              ...
              <tbody>
                ...
                while($data_nasional=mysqli_fetch_array($nasional)){
                  ...
                  $area =mysqli_query($con, "SELECT tbl_mnasional.nama_nasional, tbl_marea.status, tbl_marea.kode_area, tbl_marea.nama_area FROM tbl_marea, tbl_mnasional WHERE tbl_marea.kode_nas=tbl_mnasional.kode_nas AND tbl_marea.kode_nas='".$data_nasional['kode_nas']."'");
                  while($data_area=mysqli_fetch_array($area)){
                    ...
                    $kaper = mysqli_query($con, "SELECT tbl_perwakilan.status, tbl_perwakilan.kode_perwakilan, tbl_perwakilan.nama_kaper, tbl_perwakilan.alamat_perwakilan,tbl_mnasional.posisi FROM tbl_perwakilan, tbl_mnasional, tbl_marea WHERE tbl_perwakilan.kode_area=tbl_marea.kode_area AND tbl_marea.kode_nas=tbl_mnasional.kode_nas AND tbl_perwakilan.kode_area='".$data_area['kode_area']."'" );
                    while($data_kaper=mysqli_fetch_array($kaper)){
                      if($data_kaper['status']=='Aktif'){
                        ...
                        if($num_kaper==0 && $data_kaper['posisi'] == 'Management'){
