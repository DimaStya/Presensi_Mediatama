...
if(empty($kode_presensi)){//insert
        ...
        $insert = mysqli_query($con, "INSERT INTO tbl_presensimarea (kode_presensi, kode_area, keterangan_1, tanggal, jam_1, foto_1) VALUE ('".$kode."','".$_SESSION['kode']."','".$keterangan."','".$tgl."','".$jam1."','".$nama_baru."')");
        ...
        $update = mysqli_query($con, "UPDATE tbl_presensimarea SET keterangan_$angka='$keterangan', jam_$angka='$jam1', foto_$angka='$nama_baru' WHERE kode_presensi='$kode_presensi'");
