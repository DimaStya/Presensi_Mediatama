              ...
              <div class="scrol">
                ...
                if($hour<=strtotime('08:15')){
                  ...
                  $tanggal= date('d-m-Y');
                    ...
                    $area = mysqli_query($con, "SELECT tbl_presensimarea.foto_1,tbl_presensimarea.foto_2,tbl_presensimarea.foto_3,tbl_presensimarea.foto_4,tbl_presensimarea.foto_5,tbl_marea.nama_area, tbl_presensimarea.keterangan_1,tbl_presensimarea.keterangan_2,tbl_presensimarea.keterangan_3,tbl_presensimarea.keterangan_4,tbl_presensimarea.keterangan_5, tbl_presensimarea.jam_1,tbl_presensimarea.jam_2,tbl_presensimarea.jam_3,tbl_presensimarea.jam_4,tbl_presensimarea.jam_5, tbl_presensimarea.tanggal  FROM tbl_marea, tbl_presensimarea WHERE tbl_marea.kode_area=tbl_presensimarea.kode_area AND tbl_presensimarea.kode_area='".$_SESSION['kode']."' AND tbl_presensimarea.tanggal='".$tanggal."'");
                    while($data_area=mysqli_fetch_array($area) ){
                      echo "
                    <tr>
                      <td rowspan='2' style='vertical-align: middle; text-align: center;'>".$no."</td>
                      <td rowspan='2' style='vertical-align: middle; text-align: center;'>".$data_area['nama_area']."</td>
                      <td rowspan='2' style='vertical-align: middle; text-align: center;'>----</td>
                      <td rowspan='2' style='vertical-align: middle; text-align: center;'>".$data_area['tanggal']."</td>";
                      for($x=1; $x<=5; $x++){
                        if($data_area['foto_'.$x]!=''){
                          $gambar = "src='../images/".$data_area['foto_'.$x]."'";
                        }else{
                          $gambar="";
                        }
                        echo "
                  ...
                  echo "</tr>
                        <tr>";
                        for($x=1; $x<=5; $x++){
                          if($data_area['keterangan_'.$x]!= ''){
                            echo "
                            <td>".$data_area['keterangan_'.$x]."</td><td>Jam : ".$data_area['jam_'.$x]."</td>";
                          }else{
                            echo "<td>-----</td><td>--</td>";
                          }
                          }
                    ...
                    $sql = mysqli_query($con, "SELECT tbl_perwakilan.kode_perwakilan, tbl_mnasional.posisi FROM tbl_perwakilan, tbl_mnasional, tbl_marea WHERE tbl_perwakilan.kode_area=tbl_marea.kode_area AND tbl_marea.kode_nas=tbl_mnasional.kode_nas AND tbl_perwakilan.kode_area='".$_SESSION['kode']."'");                    
