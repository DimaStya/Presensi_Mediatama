          ...
          <div class="box-body no-padding">
            <div class="scrol">
              ...
              <tbody>
                ...
                $no =1;                  
                  $area =mysqli_query($con, "SELECT tbl_mnasional.nama_nasional, tbl_marea.status, tbl_marea.kode_area, tbl_marea.nama_area FROM tbl_marea, tbl_mnasional WHERE tbl_marea.kode_nas=tbl_mnasional.kode_nas AND tbl_marea.kode_area='".$_SESSION['kode']."'");
