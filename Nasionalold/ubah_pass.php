              ...
              if (isset($Password_baru) && ($Password_lama)) {
                ...
                if (base64_encode($Password_lama) == $data['pass']){
                  if($Password_baru == $konfirmasi_password){
                    ...
                    $updata = mysqli_query($con,"UPDATE tbl_mnasional SET email='$email' WHERE kode_nas='".$kode."'");
                    if($up && $updata){
                ...
                $updataem = mysqli_query($con,"UPDATE tbl_mnasional SET email='$email' WHERE kode_nas='".$kode."'");
                if($upem && $updataem){
