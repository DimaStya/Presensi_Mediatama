    ...
    <section class="content">
      <div class="box box-primary">
        ...
        if($hour<8-15){
          ...
          $query = mysqli_query($con, "SELECT * FROM tbl_presensimnasional WHERE tanggal= '".$tanggal."' AND kode_nas='".$_SESSION['kode']."'");
        ...
        <div class="box-body">
          <div class="form-group">
            <div class="col-xs-5">
              ...
              <input type="hidden" name="kode_nas" id="kode_nas" value="<?php echo $data['kode_nas'];?>">
            <textarea name="keterangan" id="keterangan" class="form-control" rows="5" placeholder="Enter ..." style="margin: 0px 32.5px 0px 0px; width: 350px; height: 184px;" required="required"><?php echo $data['keterangan'];?></textarea>
            </div>
          </div>
        </div>
        <?php 
