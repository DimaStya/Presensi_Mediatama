      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          <div class="col-xs-6">
            <form  id="ubah" action="" method="POST">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="email" name="email" placeholder="Enter email"   value="<?php echo $data['username']; ?>" required="">
                </div>
                <div class="form-group">
            ...
            $submit = $_POST['submit'];
            if(isset($submit)){
              if (isset($Password_baru) && ($Password_lama)) {
                ...
                if (base64_encode($Password_lama) == $data['pass']){
                  if($Password_baru == $konfirmasi_password){
                    ...
                    $updat = mysqli_query($con,"UPDATE tbl_guest SET email='$email' WHERE kode_guest='".$kode."'");
                    if($up){
