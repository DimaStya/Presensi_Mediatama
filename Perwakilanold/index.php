              ...
              <div class="box box-widget widget-user-2">
                ...
                <div class="box-footer no-padding">
                  <ul class="nav nav-stacked">
                    ...
                    $perpre = mysqli_query($con, "SELECT count(kode_perwakilan) FROM tbl_perwakilan WHERE kode_perwakilan IN (SELECT kode_perwakilan FROM tbl_presensiperwakilan)");
            ...
            <div class="col-md-3">
              <div class="box box-widget widget-user-2">
                <div class="widget-user-header bg-yellow">
                  ...
                  <h2 class="widget-user-username">SALES, ADMIN, GL</h2>
                </div>
                <div class="box-footer no-padding">
                  <ul class="nav nav-stacked">
                    <?php
                    ...
                    $salpre = mysqli_query($con, "SELECT count(kode_sales) FROM tbl_sales WHERE kode_sales IN (SELECT kode_sales FROM tbl_presensisales)");
