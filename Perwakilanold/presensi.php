    ...
    <section class="content">
      <div class="box box-primary">
        ...
        if($hour<8-15){
          ...
          $query = mysqli_query($con, "SELECT * FROM tbl_presensiperwakilan WHERE tanggal= '".$tanggal."' AND kode_perwakilan='".$_SESSION['kode']."'");
        ...
        <div class="box-body">
          <div class="form-group">
            <div class="col-xs-5">
              ...
              <input type="hidden" name="kode_perwakilan" id="kode_perwakilan" value="<?php echo $data['kode_perwakilan'];?>">
